...
Block cal_h(double init_h,double fi,int dir)
{
    ...
    double case1_min_h1[400]={0};
    double case1_max_h1[400]={0};
    double pass_max_qout[400]={0};
    double pass_min_qout[400]={0};
